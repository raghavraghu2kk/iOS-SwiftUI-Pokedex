...
struct TempPokemon: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        while !typesContainer.isAtEnd {
            let typesDicitionaryContainer = try typesContainer.nestedContainer(keyedBy: PokemonKeys.TypeDictionaryKeys.self)
            let typeContainer = try typesDicitionaryContainer.nestedContainer(keyedBy: PokemonKeys.TypeDictionaryKeys.TypeKeys.self, forKey: .type)
